...
describe('extract origin color', () => {
  ...
  it('should get value', () => {
    ...
    assert.strictEqual(res, 'rgb(from #639 r g b)', 'result');
  });
  ...
  it('should get value', () => {
    ...
    assert.strictEqual(res, 'rgb(from color(srgb 0.4 0.2 0.6) r g b)',
      'result');
  });
...
describe('resolve relative color', () => {
  ...
  it('should get value', () => {
    const res = func('rgb(from rgb(100 110 120 / 0.8) calc(r + 1) calc(g + 1) calc(b + 1) / calc(alpha + 0.01))');
    assert.strictEqual(res, 'color(srgb 0.39608 0.43529 0.47451 / 0.81)',
      'result');

    const res2 = func('rgb(from rgb(100 110 120 / 0.8) calc(r + 1) calc(g + 1) calc(b + 1) / calc(alpha + 0.01))');
    assert.strictEqual(res2, 'color(srgb 0.39608 0.43529 0.47451 / 0.81)',
      'result');
  });
  ...
  it('should get value', () => {
    const res = func('rgb(from color-mix(in srgb, currentColor, red) r g b / alpha)', {
      currentColor: 'rebeccapurple'
    });
    assert.strictEqual(res, 'color(srgb 0.7 0.1 0.3)', 'result');

    const res2 = func('rgb(from color-mix(in srgb, currentColor, red) r g b / alpha)', {
      currentColor: 'rebeccapurple'
    });
  ...
  it('should get value', () => {
    const res = func('lab(from lab(50 5 10 / 0.8) calc(l + 1) calc(a + 1) calc(b + 1) / calc(alpha + 0.01))');
  ...
  it('should get value', () => {
    const res = func('lab(from color-mix(in lab, currentColor, lab(25 20 50)) l a b / alpha)', {
      currentColor: 'lab(25 20 50)'
    });
    assert.strictEqual(res, 'lab(25 20 50)', 'result');
  });
  ...
  it('should get value', () => {
    const res = func('color(from color(srgb-linear 0.7 0.5 0.3) srgb-linear r g b)');
    assert.strictEqual(res, 'color(srgb-linear 0.7 0.5 0.3)', 'result');
  });

  it('should get value', () => {
    const res = func('color(from color(srgb-linear 0.7 0.5 0.3 / 40%) srgb-linear r g b)');
    assert.strictEqual(res, 'color(srgb-linear 0.7 0.5 0.3 / 0.4)', 'result');
  });

  it('should get value', () => {
    const res = func('color(from color(srgb-linear 0.7 0.5 0.3 / 0.8) srgb-linear calc(r + 0.01) calc(g + 0.01) calc(b + 0.01) / calc(alpha + 0.01))');
    assert.strictEqual(res, 'color(srgb-linear 0.71 0.51 0.31 / 0.81)',
      'result');
  });

  it('should get value', () => {
    const res = func('color(from color(srgb-linear 0.7 0.5 0.3) srgb-linear none none none / none)');
    assert.strictEqual(res, 'color(srgb-linear none none none / none)',
      'result');
  });

  it('should get value', () => {
    const res = func('color(from color(srgb-linear none none none / none) srgb-linear r g b / alpha)');
    assert.strictEqual(res, 'color(srgb-linear 0 0 0 / 0)',
      'result');
  });
  ...
  it('should get value', () => {
    ...
    assert.strictEqual(res, 'color(srgb-linear 0.7 0.5 0.3)',
      'result');
  });

  it('should get value', () => {
    const res = func('color(from color-mix(in xyz, currentColor, color(srgb-linear 0.7 0.5 0.3)) srgb-linear r g b / alpha)', {
      currentColor: 'color(srgb-linear 0.7 0.5 0.3)'
    });
    assert.strictEqual(res, 'color(srgb-linear 0.7 0.5 0.3)',
      'result');
  ...
  it('should get value', () => {
    ...
    assert.strictEqual(res, 'color(srgb 0.5371 0.73536 0.88083)',
      'result');
  });
  ...
  it('should get value', () => {
    const res = func('rgba(from rebeccapurple calc(r) calc(g) calc(b) / calc(alpha))', {
      format: 'specifiedValue'
    });
  ...
  it('should get value', () => {
    const res = func('rgba(from rgb(from rebeccapurple r g b) calc(r) calc(g) calc(b) / calc(alpha))', {
      format: 'specifiedValue'
    });
    assert.strictEqual(res,
  ...
  it('should get value', () => {
    ...
    assert.strictEqual(res, 'rgb(from rgba(51, 102, 153, 0.8) r g b / alpha)',
      'result');
  });
  ...
  it('should get value', () => {
    ...
    assert.strictEqual(res, 'rgb(from rgb(51, 102, 153) r g b / alpha)',
      'result');
  });
  ...
  it('should get value', () => {
    ...
    assert.strictEqual(res, 'rgb(from rgba(102, 153, 102, 0.5) r g b / alpha)',
      'result');
  });
  ...
  it('should get value', () => {
    ...
    assert.strictEqual(res, 'rgb(from rgb(from rebeccapurple r g b) r g b)',
      'result');
  });
