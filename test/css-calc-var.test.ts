...
import * as css from '../src/js/css-calc-var';
...
describe('Calculator', () => {
  ...
  it('should multiply values', () => {
    ...
    cal.etcDiv.push('r');
    const res = cal.multiply();
    assert.strictEqual(res, '-10 * alpha * b * g * r / r', 'result');
  });
  ...
  it('should multiply values', () => {
    ...
    cal.etcDiv.push('r');
    const res = cal.multiply();
    assert.strictEqual(res, 'alpha * b * g * r / r', 'result');
  });
  ...
  it('should multiply values', () => {
    ...
    cal.etcDiv.push('r', 'g');
    const res = cal.multiply();
    assert.strictEqual(res, '1 / (g * r)', 'result');
  });
...
describe('resolve dimension', () => {
  const func = css.resolveDimension;
...
describe('parse CSS calc() tokens', () => {
...
describe('CSS calc()', () => {
  ...
  it('should get value', () => {
    const res = func('calc(100vh + 10px)', {
      format: 'specifiedValue'
    });
    assert.strictEqual(res, 'calc(10px + 100vh)', 'result');

    const res2 = func('calc(100vh + 10px)', {
      format: 'specifiedValue'
    });
    assert.strictEqual(res2, 'calc(10px + 100vh)', 'result');
  });
...
describe('resolve CSS variable', () => {
  const func = css.resolveCustomProperty;
