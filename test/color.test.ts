...
describe('validate color components', () => {
  ...
  it('should throw', () => {
    assert.throws(
      () => func([0, 128, 192, 1.1], { maxRange: 255 }),
      RangeError,
      '1.1 is not between 0 and 1.'
    );
  });
  ...
  it('should throw', () => {
    assert.throws(
      () => func([0, 128, 192, 1], { minLength: 'foo' }),
      TypeError,
      'foo is not a number.'
    );
  });
  ...
  it('should throw', () => {
    assert.throws(
      () => func([0, 128, 192, 1], { maxLength: 'foo' }),
      TypeError,
      'foo is not a number.'
    );
  });
...
describe('convert hex to rgb', () => {
  ...
  it('should throw', () => {
    assert.throws(() => func('#1'), SyntaxError, 'Invalid property value: #1');
  });
...
describe('parse lab()', () => {
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['xyz-d50', 0.0831303, 0.154765, 0.020967, 1],
      'result'
    );
  });
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['xyz-d50', 0.288683, 0.184187, 0.151973, 1],
      'result'
    );
  });
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['xyz-d50', 0.266509, 0.407494, 0.336225, 1],
      'result'
    );
  });
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['xyz-d50', 0.392945, 0.407494, 0.0494655, 1],
      'result'
    );
  });
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['xyz-d50', 0.221111, 0.229298, 0.626026, 1],
      'result'
    );
  });
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['xyz-d50', 0.200518, 0.140888, 0.447232, 1],
      'result'
    );
  });
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['xyz-d50', 0.200518, 0.140888, 0.447232, 0.5],
      'result'
    );
  });
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['xyz-d50', 0.200518, 0.140888, 0.447232, 0],
      'result'
    );
  });
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['xyz-d50', 0.0184044, 0.000553528, -0.0326554, 1],
      'result'
    );
  });
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['xyz-d50', 0.322273, 0.184187, 0.149483, 1],
      'result'
    );
  });
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['xyz-d50', 0.178783, 0.184187, 0.0139186, 1],
      'result'
    );
  });
...
describe('parse lch()', () => {
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['xyz-d50', 0.0831125, 0.15475, 0.0209589, 1],
      'result'
    );
  });
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['xyz-d50', 0.200515, 0.140888, 0.447126, 1],
      'result'
    );
  });
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['xyz-d50', 0.200515, 0.140888, 0.447126, 0.5],
      'result'
    );
  });
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['xyz-d50', 0.200515, 0.140888, 0.447126, 0],
      'result'
    );
  });
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['xyz-d50', 0.00482348, 0.000553528, -0.00484122, 1],
      'result'
    );
  });
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['xyz-d50', 0.0109845, 0.0112602, 0.00913626, 1],
      'result'
    );
  });
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['xyz-d50', 0.0202958, 0.0112602, 0.00118747, 1],
      'result'
    );
  });
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['xyz-d50', 0.0167108, 0.0112602, 0.0169987, 1],
      'result'
    );
  });
...
describe('parse oklab()', () => {
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['xyz-d65', 0.0771884, 0.154375, 0.0257248, 1],
      'result'
    );
  });
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['xyz-d65', 0.139023, 0.120254, 0.131325, 1],
      'result'
    );
  });
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['xyz-d65', 0.253459, 0.361799, 0.392252, 1],
      'result'
    );
  });
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['xyz-d65', 0.330466, 0.341821, 0.0788701, 1],
      'result'
    );
  });
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['xyz-d65', 0.208919, 0.155096, 0.75298, 1],
      'result'
    );
  });
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['xyz-d65', 0.216593, 0.145996, 0.594355, 1],
      'result'
    );
  });
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['xyz-d65', 0.216593, 0.145996, 0.594355, 0.5],
      'result'
    );
  });
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['xyz-d65', 0.216593, 0.145996, 0.594355, 0],
      'result'
    );
  });
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['xyz-d65', -0.000790021, 0.000266762, -0.00617548, 1],
      'result'
    );
  });
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['xyz-d65', -0.000962546, 0.000293252, -0.00677682, 1],
      'result'
    );
  });
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['xyz-d65', 0.00261129, 0.000703706, 0.000668526, 1],
      'result'
    );
  });
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['xyz-d65', 0.00201133, 0.000799226, -0.000751157, 1],
      'result'
    );
  });
...
describe('parse oklch()', () => {
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['xyz-d65', 0.0771872, 0.154375, 0.0257271, 1],
      'result'
    );
  });
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['xyz-d65', 0.208742, 0.106235, 0.116683, 1],
      'result'
    );
  });
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['xyz-d65', 0.164463, 0.114827, 0.62784, 1],
      'result'
    );
  });
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['xyz-d65', 0.347224, 0.547341, 0.401545, 1],
      'result'
    );
  });
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['xyz-d65', 0.234241, 0.14918, 0.239504, 1],
      'result'
    );
  });
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['xyz-d65', 0.212588, 0.142275, 0.58731, 1],
      'result'
    );
  });
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['xyz-d65', 0.212588, 0.142275, 0.58731, 0.5],
      'result'
    );
  });
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['xyz-d65', 0.212588, 0.142275, 0.58731, 0],
      'result'
    );
  });
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['xyz-d65', 0.147667, 0.118516, 0.0757682, 1],
      'result'
    );
  });
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['xyz-d65', 0.00000371006, 0.0000109137, -0.000310562, 1],
      'result'
    );
  });
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['xyz-d65', 0.0026038, 0.000703632, 0.000735212, 1],
      'result'
    );
  });
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['xyz-d65', 0.0372685, -0.0000535228, -0.0310754, 1],
      'result'
    );
  });
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['xyz-d65', 0.000950456, 0.001, 0.00108906, 1],
      'result'
    );
  });
...
describe('parse color func', () => {
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['xyz-d65', 0.0765378, 0.153076, 0.0255126, 1],
      'result'
    );
  });
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['xyz-d50', 0.0824383, 0.153443, 0.0207794, 1],
      'result'
    );
  });
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['xyz-d65', 0.113907, 0.227815, 0.0379691, 1],
      'result'
    );
  });
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['xyz-d50', 0.122689, 0.228362, 0.0309249, 1],
      'result'
    );
  });
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['xyz-d65', 0.203437, 0.214041, 0.233103, 0.5],
      'result'
    );
  });
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['xyz-d65', 0.113907, 0.227815, 0.0379691, 0.5],
      'result'
    );
  });
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['xyz-d65', 0.113907, 0.227815, 0.0379691, 0],
      'result'
    );
  });
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['xyz-d65', 0.0771882, 0.154376, 0.0257294, 1],
      'result'
    );
  });
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['xyz-d50', 0.0831388, 0.154747, 0.020956, 1],
      'result'
    );
  });
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['xyz-d65', 0.113905, 0.227813, 0.037968, 1],
      'result'
    );
  });
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['xyz-d50', 0.122687, 0.22836, 0.0309241, 1],
      'result'
    );
  });
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['xyz-d65', 0.113905, 0.22781, 0.0379681, 1],
      'result'
    );
  });
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['xyz-d50', 0.122686, 0.228357, 0.0309241, 1],
      'result'
    );
  });
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['xyz-d50', 0.165697, 0.675318, 0.0299778, 1],
      'result'
    );
  });
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['xyz-d65', 0.113904, 0.22781, 0.0379676, 1],
      'result'
    );
  });
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['xyz-d50', 0.122685, 0.228357, 0.0309238, 1],
      'result'
    );
  });
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['xyz-d65', 0.11388, 0.227813, 0.0379771, 1],
      'result'
    );
  });
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['xyz-d50', 0.12266, 0.228359, 0.0309312, 1],
      'result'
    );
  });
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['xyz-d65', 0.11272, 0.715115, -0.0129334, 1],
      'result'
    );
  });
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['xyz-d65', 0.0771895, 0.154379, 0.0257347, 1],
      'result'
    );
  });
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['xyz-d65', 0.538065, 0.787361, 1.06973, 1],
      'result'
    );
  });
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['xyz-d65', 0.592872, 0.284831, 0.969863, 1],
      'result'
    );
  });
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['xyz-d65', 0.769975, 0.927808, 0.138526, 1],
      'result'
    );
  });
...
describe('parse color value', () => {
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['xyz-d65', 0.0771883, 0.154377, 0.0257294, 1],
      'result'
    );
  });
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['xyz-d50', 0.083139, 0.154748, 0.020956, 1],
      'result'
    );
  });
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['xyz-d65', 0.0771883, 0.154377, 0.0257294, 0.5],
      'result'
    );
  });
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['xyz-d50', 0.083139, 0.154748, 0.020956, 0.5],
      'result'
    );
  });
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['xyz-d65', 0.0880377, 0.176075, 0.0293459, 1],
      'result'
    );
  });
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['xyz-d65', 0.0880377, 0.176075, 0.0293459, 0.533],
      'result'
    );
  });
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['xyz-d65', 0.0771803, 0.154395, 0.0257436, 1],
      'result'
    );
  });
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(res2, ['lab', 46.28, -47.57, 48.58, 1], 'result');
  });
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['xyz-d65', 0.0771771, 0.154375, 0.0257325, 1],
      'result'
    );
  });
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['xyz-d50', 0.083127, 0.154746, 0.0209584, 1],
      'result'
    );
  });
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['xyz-d50', 0.0831393, 0.154746, 0.0209525, 1],
      'result'
    );
  });
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['xyz-d50', 0.0831379, 0.154746, 0.0209542, 1],
      'result'
    );
  });
...
describe('resolve color-mix()', () => {
  ...
  it('should get value', () => {
    ...
    assert.strictEqual(res, 'color-mix(in srgb, blue 60%, red 60%)', 'result');
  });
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['srgb-linear', 0.107931, 0.107931, 0.10793, 1],
      'result'
    );
  });
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['srgb-linear', 0.538462, 0.461538, 0.149056, 0.325],
      'result'
    );
  });
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['xyz-d65', 0.24479, 0.183508, 0.0225301, 1],
      'result'
    );
  });
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['xyz-d65', 0.244464, 0.182858, 0.0224217, 0.5],
      'result'
    );
  });
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['xyz-d65', 0.128835, 0.113285, 0.488131, 0],
      'result'
    );
  });
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['xyz-d50', 0.259603, 0.18862, 0.0174399, 1],
      'result'
    );
  });
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['xyz-d50', 0.259252, 0.187968, 0.0173516, 0.5],
      'result'
    );
  });
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['xyz-d50', 0.259603, 0.18862, 0.0174399, 0],
      'result'
    );
  });
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['srgb', 0.423529, 0.403922, 0.258824, 0.85],
      'result'
    );
  });
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['oklab', 0.573854, 0.0422802, 0.116761, 1],
      'result'
    );
  });
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['oklab', 0.240129, 0.0666374, 0.0483318, 0.75],
      'result'
    );
  });
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['oklab', 0.530572, -0.103786, 0.109493, 1],
      'result'
    );
  });
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['oklab', 0.519752, -0.140303, 0.107676, 1],
      'result'
    );
  });
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['oklab', 0.573854, 0.0422802, 0.116761, 0],
      'result'
    );
  });
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['oklch', 0.240129, 0.0963786, 85.8646, 0.75],
      'result'
    );
  });
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(res, ['oklch', 0.617135, 0.249601, 40.56, 1], 'result');
  });
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(res, ['oklch', 0.519752, 0.176859, 142.495, 1], 'result');
  });
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(res, ['oklch', 0.627955, 0.257683, 29.2339, 1], 'result');
  });
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(res, ['oklch', 0.573854, 0.217271, 85.8646, 0], 'result');
  });
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['srgb', 0.333333, 0.16732, 0.333333, 0.75],
      'result'
    );
  });
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['srgb', 0.334641, 0.16732, 0.334641, 0.75],
      'result'
    );
  });
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['oklab', 0.44711, 0.0903907, -0.0947484, 1],
      'result'
    );
  });
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['oklab', 0.439, 0.109966, -0.128598, 0.875],
      'result'
    );
  });
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['xyz-d65', 0.128509, 0.112634, 0.488022, 'none'],
      'result'
    );
  });
  ...
  it('should get value', () => {
    ...
    assert.deepEqual(
      res,
      ['xyz-d50', 0.112758, 0.107031, 0.367439, 'none'],
      'result'
    );
  });
