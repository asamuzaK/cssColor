...
describe('validate color components', () => {
  ...
  it('should throw', () => {
    expect(() => func([1, 1, 1, 1], { maxLength: 3 }))
      .toThrow('Unexpected array length 4.');
  });
  ...
  it('should throw', () => {
    ...
    expect(() => func([0, 128, 256, 1], { maxRange: 255 })).toThrow('256 is not between 0 and 255.');
  });

  it('should throw', () => {
    expect(() => func([0, -128, 192, 1], { maxRange: 255 })).toThrow(RangeError);
    expect(() => func([0, -128, 192, 1], { maxRange: 255 })).toThrow('-128 is not between 0 and 255.');
  });

  it('should throw', () => {
    expect(() => func([0, 128, 192, 1.1], { maxRange: 255 })).toThrow(RangeError);
    expect(() => func([0, 128, 192, 1.1], { maxRange: 255 })).toThrow('1.1 is not between 0 and 1.');
  });

  it('should throw', () => {
    expect(() => func([0, 128, 192, 1], { minLength: 'foo' })).toThrow(TypeError);
    expect(() => func([0, 128, 192, 1], { minLength: 'foo' })).toThrow('foo is not a number.');
  });

  it('should throw', () => {
    expect(() => func([0, 128, 192, 1], { maxLength: 'foo' })).toThrow(TypeError);
    expect(() => func([0, 128, 192, 1], { maxLength: 'foo' })).toThrow('foo is not a number.');
  });

  it('should throw', () => {
    expect(() => func([0, 128, 192, 1], { minRange: 'foo' })).toThrow(TypeError);
    expect(() => func([0, 128, 192, 1], { minRange: 'foo' })).toThrow('foo is not a number.');
  });

  it('should throw', () => {
    expect(() => func([0, 128, 192, 1], { maxRange: 'foo' })).toThrow(TypeError);
    expect(() => func([0, 128, 192, 1], { maxRange: 'foo' })).toThrow('foo is not a number.');
  });
...
describe('transform matrix', () => {
  ...
  it('should throw', () => {
    expect(() => func([[1, 0, 0], [0, 1, 0], [0, 0, 1]])).toThrow(TypeError);
    expect(() => func([[1, 0, 0], [0, 1, 0], [0, 0, 1]])).toThrow('undefined is not an array.');
  });

  it('should throw', () => {
    expect(() => func([[1, 0, 0], [0, 1, 0], [0, 0, 1]], [])).toThrow('Unexpected array length 0.');
  });

  it('should throw', () => {
    expect(() => func([[1, 0, 0], [0, 1, 0], [0, 0, 1]], [1, 0, NaN])).toThrow(TypeError);
    expect(() => func([[1, 0, 0], [0, 1, 0], [0, 0, 1]], [1, 0, NaN])).toThrow('NaN is not a number.');
  });
...
describe('convert rgb to xyz', () => {
  ...
  it('should throw', () => {
    ...
    expect(() => func([255, 255, 255, -1])).toThrow('-1 is not between 0 and 1.');
  });

  it('should throw', () => {
    expect(() => func([255, 255, 255, 1.1])).toThrow(RangeError);
    expect(() => func([255, 255, 255, 1.1])).toThrow('1.1 is not between 0 and 1.');
  });
...
describe('convert rgb to xyz-d50', () => {
  ...
  it('should get value', () => {
    ...
    res[1] = parseFloat(res[1].toFixed(4));
    res[2] = parseFloat(res[2].toFixed(4));
    expect(res).toEqual([0.0831, 0.1547, 0.0210, 1]);
  });
...
describe('convert hex to rgb', () => {
  ...
  it('should throw', () => {
    ...
    expect(() => func('#123456789')).toThrow('Invalid property value: #123456789');
  });
...
describe('resolve color-mix()', () => {
  ...
  it('should get value', () => {
    ...
    expect(res).toBe(
      'color-mix(in srgb, blue 60%, red 60%)'
    );
  });
