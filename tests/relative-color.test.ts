...
describe('resolve relative color', () => {
  ...
  it('should get value', () => {
    ...
    expect(res).toBe('rgb(from rebeccapurple calc(r) calc(g) calc(b) / calc(alpha))');
  });
  ...
  it('should get value', () => {
    ...
    expect(res).toBe('rgb(from rgb(from rebeccapurple r g b) calc(r) calc(g) calc(b) / calc(alpha))');
  });
  ...
  it('should get value', () => {
    ...
    expect(res).toBe('rgb(from rgb(from rebeccapurple r g b) r calc((0.5 * g) + (0.5 * g)) 10)');
  });
