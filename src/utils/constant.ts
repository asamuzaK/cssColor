...
export const HEX = 16;
export const LAB_A = 500;
export const LAB_B = 200;
export const LAB_EPSILON = 216 / 24389;
export const LAB_KAPPA = 24389 / 27;
export const LAB_L = 116;
export const LINEAR_COEF = 12.92;
export const LINEAR_OFFSET = 0.055;
export const MAX_LENGTH = 1024;
export const MAX_PCT = 100;
export const MAX_RGB = 255;
export const OCT = 8;
export const POW_CUBE = 3;
export const POW_LINEAR = 2.4;
export const POW_SQR = 2;
export const PPTH = 0.001;
export const QUAD = 4;
export const SEXA = 60;
export const TRIA = 3;
